-- A partir desta migration, as notificações operacionais da plataforma
-- são destinadas somente às contas com papel admin.
-- O antigo gatilho que notificava o proprietário é removido.
...
BEGIN
  ...
  LOOP
    ...
    VALUES (admin_user, notification_title, notification_body,
