...
function GuestCartPage() {
  ...
  const checkout = async () => {
    ...
    if (!minimumMet) { toast.error(`O pedido mínimo é ${brl(minimumOrder)}.`); return; }
