...
function GuestCartPage() {
  ...
  const checkout = async () => {
    ...
    if (!checkIn || !checkOut || !apartmentCode.trim()) { toast.error("Informe a data de check-in, check-out e o código do apartamento."); return; }
    if (checkOut <= checkIn) { toast.error("A data de check-out deve ser posterior ao check-in."); return; }
